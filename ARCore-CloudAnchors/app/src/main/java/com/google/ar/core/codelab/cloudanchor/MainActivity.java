...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
      ...
      if (anchor == null
        ...
        for (HitResult hit : currentFrame.hitTest(queuedSingleTap)) {
          if (shouldCreateAnchorWithHit(hit)) {
            ...
            setNewAnchor(newAnchor); // Change this line.
  ...
  // Function to Check the Anchor Update
...
//
//        // Use this line to get the Cloud Anchor ID
////        snackbarHelper.showMessageWithDismiss(
////                this, "Anchor hosted successfully! Cloud ID: " + anchor.getCloudAnchorId());
//
//        // Use this line to get the Short Cloud Anchor ID
//        snackbarHelper.showMessageWithDismiss(
...
//  }
  ...
  // Function to Check Updated Anchor
  private void checkUpdatedAnchor() {
    synchronized (singleTapAnchorLock) {
 ...
 // Function to execute when pressed on Resolve
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    clearButton.setOnClickListener(
      ...
      // Add these lines for Resolve Button
