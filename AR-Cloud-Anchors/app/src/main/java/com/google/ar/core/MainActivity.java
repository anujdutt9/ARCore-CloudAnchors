...
// Reference: Google ARCore Github Repository
...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  ...
  final String SOUND_FILE = "ping_mono.wav";
  //final String SOUND_FILE = "conversation.wav";
  private Pose arPose;

  // Head Orientation Tracking for Binaural Audio
  private volatile int soundId = GvrAudioEngine.INVALID_ID;
  protected float[] modelCube;
  float[] translation = new float[3];
  // ---------------------------------------------------------------------

  // Initialize Storage Manager to Store Key Value Pairs of Cloud ID's and Short Numbers
      ...
      if (anchor == null
        ...
        for (HitResult hit : currentFrame.hitTest(queuedSingleTap)) {
          if (shouldCreateAnchorWithHit(hit)) {
            ...
            mGvrAudioEngine.playSound(soundId, true);
            mGvrAudioEngine.setSoundObjectDistanceRolloffModel(soundId, GvrAudioEngine.DistanceRolloffModel.LOGARITHMIC, 0, 9);
            mSounds.add(soundId);
            // ------------------------------------------------------------------------
...
//            setNewAnchor(newAnchor);
  ...
  // Function to Resolve Anchor using Unique ID
    ...
    // Get Anchor Parameters and Try to save that into Firebase, get a short code for Cloud ID.
  // If Resolving, try to match the scene and place the Anchor
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.google.ar.core.codelab.cloudanchor.R.layout.activity_main);
    surfaceView = findViewById(com.google.ar.core.codelab.cloudanchor.R.id.surfaceview);
    displayRotationHelper = new DisplayRotationHelper(/*context=*/ this);
    storageManager = new StorageManager(this);

    // HEAD TRACKING for 3-D Binaural Audio
    ...
    // -------------------------- Initialize 3-D Binaural Audio Engine ----------------------------------
    ...
    Button clearButton = findViewById(com.google.ar.core.codelab.cloudanchor.R.id.clear_button);
  ...
  protected void onResume() {
    ...
    if (session == null) {
      ...
      try {
        ...
        messageId = com.google.ar.core.codelab.cloudanchor.R.string.snackbar_arcore_unavailable;
        exception = e;
      } catch (UnavailableApkTooOldException e) {
        messageId = com.google.ar.core.codelab.cloudanchor.R.string.snackbar_arcore_too_old;
        exception = e;
      } catch (UnavailableSdkTooOldException e) {
        messageId = com.google.ar.core.codelab.cloudanchor.R.string.snackbar_arcore_sdk_too_old;
        exception = e;
      } catch (Exception e) {
        messageId = com.google.ar.core.codelab.cloudanchor.R.string.snackbar_arcore_exception;
        exception = e;
      }
    ...
    snackbarHelper.showMessage(this, "Searching for surfaces...");
    Toast.makeText(this, "Wear Headphones for Best Experience...", Toast.LENGTH_LONG)
            .show();
    // ---------------------------------------------------------------------------
  }
  ...
  public void onDrawFrame(GL10 gl) {
    ...
    try {
      ...
      if (shouldDrawAnchor) {
        ...
        // ------------------ 3-D Binaural Audio -----------------
        mGvrAudioEngine.setSoundObjectPosition(mSounds.get(0), translation[0], translation[1], translation[2]);
        arPoseToVrAudio(frame, mGvrAudioEngine);
        // -------------------------------------------------------
      }
    } catch (Throwable t) {
  ...
  // ----------------------- 3-D Binaural Audio -----------------------------
  // Function to change audio volume based on camera pose w.r.t AR Object
  static void arPoseToVrAudio(Frame arFrame, GvrAudioEngine vrAudioEngine) {
    // Extract positional data
    float[] translation = new float[3];
    arFrame.getCamera().getPose().getTranslation(translation,0);

    float[] rotation = new float[4];
    arFrame.getCamera().getPose().getRotationQuaternion(rotation,0);

    // Update audio engine
    vrAudioEngine.setHeadPosition(translation[0], translation[1], translation[2]);
    vrAudioEngine.setHeadRotation(rotation[0], rotation[1], rotation[2], rotation[3]);
    vrAudioEngine.update();
  }
  // -------------------------------------------------------------------------
}
